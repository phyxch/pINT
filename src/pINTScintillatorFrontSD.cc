...
pINTScintillatorFrontSD::pINTScintillatorFrontSD(G4String name,
...
pINTScintillatorFrontSD::~pINTScintillatorFrontSD()
{
...
void pINTScintillatorFrontSD::Initialize(G4HCofThisEvent* HCE)
{
...
G4bool pINTScintillatorFrontSD::ProcessHits(G4Step* aStep,G4TouchableHistory* ROhist)
{
  ...
  */
  ...
  if (physVol == Detector->GetFrontScintillator()) {
...
void pINTScintillatorFrontSD::EndOfEvent(G4HCofThisEvent* HCE)
{
  static G4int HCID = -1;
  if(HCID<0)
    { 
  ...
  // G4cout << " (pINTScintillatorFrontSD) nhits: *** " << nhits << "  HCID: " << HCID << G4endl;
...
void pINTScintillatorFrontSD::clear()
{} 

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void pINTScintillatorFrontSD::DrawAll()
{} 

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void pINTScintillatorFrontSD::PrintAll()
{} 
